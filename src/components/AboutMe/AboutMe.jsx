...
import bootstrap from './../../assets/images/BOOSTRAP ICON.png'
import mongo from './../../assets/images/MONGO DB ICON.png'
        ...
        <>
            {language === "english" && (
                ...
                <div className="mt-5">
                    ...
                    <img style={{ width: '75%' }} src={arrow} alt="" />
                    <div className="mt-5 d-flex">
                        <Row className='justify-content-center'>

                            <Col md={3}>
                                <img className='mt-5' src={html} alt="" />
                                <img className='mt-5' src={react} alt="" />
                                <img className='mt-5' src={express} alt="" />
                            </Col>
                            <Col md={3}>
                                <img className='mt-5' src={css} alt="" />
                                <img className='mt-5' src={node} alt="" />
                                <img className='mt-5' src={bootstrap} alt="" />
                            </Col>
                            <Col md={3}>
                                <img className='mt-5' src={javascript} alt="" />
                                <img className='mt-5' src={mongo} alt="" />
                                <img className='mt-5' src={postman} alt="" />
                            </Col>
                        </Row>
                    </div>
                </div>
