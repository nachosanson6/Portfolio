                ...
                <div>
                    ...
                    <div className="ms-5 mt-5">
                        <Row>
                            ...
                            <Col md={5} className="ms-5 mt-5" style={{ color: 'white', fontFamily: 'Epilogue' }}>
                                <h2 className="ms-5 mt-5" style={{ fontSize: '4 rem', fontWeight: 'bold' }}>JamLink</h2>
                                <p className="ms-5" style={{ fontSize: '2.5 rem' }}>Sep 2023</p>
                                <Link to={'/jamlink'} className="ms-5" style={{ color: 'white' }}>See more</Link>
                            </Col >
                        </Row >
                    </div>
                </div >
